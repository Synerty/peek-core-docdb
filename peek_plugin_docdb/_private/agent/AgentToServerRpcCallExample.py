...
from peek_plugin_docdb._private.server.agent_handlers.RpcForAgent import RpcForAgent
...
class AgentToServerRpcCallExample:
    ...
    def run(self):
        ...
        document = DocumentTuple(int1=50, string1="Created from Agent RPC")

        d = RpcForAgent.addDocument(document)

        # the deferred will call the lambda function,
        #   "_" will be the result of "addDocument, which we ignore
